        ...
        c || (c = "notify"), b && d.addClass(b + "-ready"), a.find("form").validate({
            errorPlacement: function (b, a) {
                ...
                f.hide(), "button" == e ? (defButtonText = (h = $(j).find("button")).html(), h.html('<i class="icon-line-loader icon-spin m-0"></i>')) : $(j).find(".form-process").fadeIn(), b && d.removeClass(b + "-ready " + b + "-complete " + b + "-success " + b + "-error").addClass(b + "-processing"), $(j).ajaxSubmit({
                    target: f, dataType: "json", success: function (a) {
...
window.SEMICOLON_onePageModule = function (a) {
    ...
    var $ = {
        ...
        updateSize: function () {
            ...
            let a = this, e = a.rtlTranslate ? a.translate : -a.translate, {
                slidesGrid: d,
                snapGrid: g,
                params: h,
                activeIndex: i,
    ...
    let m = [function (c) {
        ...
        function f(k) {
            let {slidesPerView: l, slidesPerGroup: g, centeredSlides: x} = b.params, {
                addSlidesBefore: r,
                addSlidesAfter: s
            } = b.params.virtual, {from: m, to: j, slides: t, slidesGrid: y, offset: z} = b.virtual;
        ...
        c({cardsEffect: {slideShadows: !0, transformEl: null, rotate: !0}}), ac({
            ...
            on: d,
            setTranslate() {
                let {slides: f, activeIndex: g} = b, h = b.params.cardsEffect, {
                    startTranslate: p,
                    isTouched: q
                } = b.touchEventsData, r = b.translate;
